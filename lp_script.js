...
// FAQ
setText('faq_q1', data.faq_q1); setText('faq_a1', data.faq_a1);
setText('faq_q2', data.faq_q2); setText('faq_a2', data.faq_a2);
setText('faq_q3', data.faq_q3); setText('faq_a3', data.faq_a3);
